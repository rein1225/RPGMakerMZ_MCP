...
server.setRequestHandler(ListToolsRequestSchema, async () => {
  return {
    tools: [
      ...
      {
        name: "run_playtest",
        description: "Launch the game (Game.exe) and take a screenshot after a delay. Can optionally close the game automatically and start a new game.",
        inputSchema: {
          type: "object",
          properties: {
            projectPath: {
      ...
      {
        name: "add_loop",
        description: "Add a Loop block (Loop + Repeat Above) to a map event.",
        inputSchema: {
          type: "object",
          properties: {
            ...
            insertPosition: { type: "number", description: "Insert position (-1 for end)" },
          },
      ...
      {
        name: "add_break_loop",
        description: "Add a Break Loop command to a map event.",
        inputSchema: {
          type: "object",
          properties: {
            projectPath: { type: "string" },
